...
public class LoginWrongPassTest extends TestBase {
    private static final int WAIT = 2000;
    private static final String USERNAME = "gandalf";
    private static final String WRONG_PASSWORD = "thewhite";
    ...
    @Test
    public void verifyUserCannotLoginWithWrongPassword() throws InterruptedException {
        ...
        log.info("STEP 5: The user has provided a wrong password");
        sleepy(WAIT);
        ...
        log.info("STEP 8: The user has not logged-in. Wrong password provided!");
        sleepy(WAIT);
    }
}
